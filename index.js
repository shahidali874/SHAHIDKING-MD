...
async function startconn() {
    ...
    console.log(chalk.cyan(`║        🤖 SHAHID KING  PAIRING MODE       ║`))
    console.log(chalk.cyan(`╚════════════════════════════════════╝`))
...
├─ 🌟 *GitHub:*  
│    https://github.com/shahidali874/SHAHID-KING-MD 
...
`,
            ...
            console.log(chalk.green(`${global.themeemoji || '•'} 🤖 SHAHID KING Connected Successfully! ✅`))
            console.log(chalk.cyan(`< ================================================== >`))
        }
        if (
            connection === "close" &&
